...
(1,'pyres02','e10adc3949ba59abbe56e057f20f883e',0,'2019-01-11 17:50:11',NULL,NULL,NULL,NULL,NULL,0,NULL,1),
(2,'test','123456',0,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,1),
(3,'test1','123456',0,'2019-01-11 18:01:02',NULL,NULL,NULL,NULL,NULL,0,NULL,1);
...
CREATE TABLE `shop` (
  ...
  KEY `typeId` (`typeId`),
  KEY `topicId` (`topicId`),
  CONSTRAINT `shop_ibfk_1` FOREIGN KEY (`typeId`) REFERENCES `shoptype` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
CREATE TABLE `shoptype` (
  ...
  `pid` tinyint(4) NOT NULL DEFAULT '0' COMMENT '父类id',
  `remark` varchar(200) COLLATE utf8_bin DEFAULT NULL COMMENT '说明',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `user` (
  ...
  `sex` tinyint(1) NOT NULL DEFAULT '0' COMMENT '性别',
  `realName` varchar(15) COLLATE utf8_bin DEFAULT NULL COMMENT '真实姓名',
  ...
  `qrcode` varchar(150) COLLATE utf8_bin NOT NULL COMMENT '二维码',
  `inviter` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '邀请人',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态',
  `isDelete` tinyint(1) NOT NULL DEFAULT '0' COMMENT '软删除',
  PRIMARY KEY (`id`),
  KEY `rank_id` (`rankId`),
  CONSTRAINT `user_ibfk_1` FOREIGN KEY (`rankId`) REFERENCES `rank` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
